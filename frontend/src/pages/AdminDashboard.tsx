    ...
    <div className="max-w-7xl mx-auto px-4 py-10">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        ...
        <Link to="/admin/products" className="block">
          <div className="clay-card-md hover:shadow-lg transition-shadow duration-300 p-6 flex flex-col items-center justify-center text-center h-48">
        ...
        <div className="block cursor-not-allowed opacity-70">
          <div className="clay-card-md p-6 flex flex-col items-center justify-center text-center h-48">
